...
public class ProductListingRouteController extends BaseRouteController {
	...
	public ModelAndView showProductListing(@RequestParam final Map<String,String> queryParameters, final HttpServletRequest request) {
		...
		ModelAndView modelAndView = this.setErrorMessageFromQueryString(new ModelAndView(ViewNames.PRODUCT_LISTING.getViewName()), queryParameters);
